...
async function applyBranding() {
  ...
  function SetToggle() {
    ...
    function updateToggle() {
      ...
      if (toggleBtn.checked) {
        ...
        monthlyText.style.color = Prime3;
        yearlyText.style.color = Prime2;
        ...
        monthlyText.style.color = Prime2;
        yearlyText.style.color = Prime3;
  ...
  setImgs(BuLogo, Buissnes.BuLogos.LogoText.description,'buLogo');  
