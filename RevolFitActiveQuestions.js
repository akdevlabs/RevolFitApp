...
async function applyBranding() {
  ...
  function setContent(){
   ...
   setBgImgs(Buissnes.UBU.BuIcon.BuLight, Buissnes.UBU.LogoText.Logo.description, "LogoImg")
   setBgImgs(Buissnes.UBU.BuIcon.BuLight, Buissnes.UBU.LogoText.Logo.description,"MultiBlockkImg")
   setBgImgs(Buissnes.UBU.BuIcon.BuLight, Buissnes.UBU.LogoText.Logo.description,"MultiQBlockkImg")
   setBgImgs(Buissnes.UBU.BuIcon.BuLight, Buissnes.UBU.LogoText.Logo.description,"MultiQ2BlockkImg")
